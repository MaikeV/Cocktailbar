...
<head>
    ...
    <link rel="stylesheet" href="vcss\bootstrap.min.css">
                        ...
                        <?php
                          if(isset($_SESSION["login"]) && $_SESSION["login"] == 1){
                            ...
                            echo "<a type='submit' class='navBarItem navButton' href='login.php' target='display'>Einloggen</a>
                                  ...
                                  <a type='submit' class='navBarItem navButton' href='neddedLogin.php' target='display'>Neuen Cocktail erstellen</a>";
                          }
                         ?>
